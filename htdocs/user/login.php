...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		// general
		$structure = NULL;
		$structure["fieldname"] 	= "username_absportal";
		$structure["type"]		= "input";
		$this->obj_form->add_input($structure);
		
		$structure = NULL;
		$structure["fieldname"] 	= "password_absportal";
	...
	function render_html()
	{
		...
		print "<p>Please enter your CUSTOMER ID and PASSWORD to access this portal.</p>";
